...
<div class="doctors-page-wrapper">
  ...
  <div class="our_doctors">
    <?php
    include '../connect.php';
   $sql = "SELECT * FROM doctor WHERE Resgistration_Number != $user_id AND (First_Name LIKE '%$search%' OR Middle_Initials LIKE '%$search%'OR Last_Name LIKE '%$search%' OR Specialty_Type LIKE '%$search%' OR Bio LIKE '%$search%')";
    ...
    <?php
      ...
      echo '<script>alert("Doctor not found!");window.location.href="Doctors-page.php";</script>';
    }
    ?>
  </div>
</div>
