...
<div class="order-chat-section">
								<div class="order-chat-header" id="info">
									<div class="order-store-detail">
										<div class="order-store-img bg-dark-shop">
											<img onclick="openPopup(this)" src="../../img/Doctors/<?php echo $row['Image']; ?>" alt="">
           ...
           <?php
            if($row['status']=="Active now"){echo "<p>" . $row['status'] . "</p>";}
           else{echo '<p style="color: red">' . $row['status'] . '</p>';}
           ?>
           ...
           <div class="order-chat-enter-area">
            ...
            <input type="text" name="message" class="form-control" placeholder="Type a message here..." autocomplete="off">
              ...
              <div class="chat-actions-button">
               <a href="javascript:void(0);" class="chat-attach-link"> <img src="../../img/icons/icons8-add-image-48.png" alt="">
...
setInterval(function() {
    ...
    xhttp.open("GET", "status.php?user_id=" + user_id, true);
    xhttp.send();
