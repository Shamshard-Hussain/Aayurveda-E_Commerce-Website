        ...
        <div class="side-content">
            ...
            <div class="side-menu">
                <ul>
                    ...
                    <li>
                       <a href="Admin-View-product-list-Page.php"  class="active">
                            <span><img src="../img/icons/icons8-packing-30 (1).png"/></span>
    ...
    <div class="main-content">
        ...
        <main>
            ...
            <div class="page-header">
                <h1>Product</h1>
                <small>Add / Update / View / Search / Delete</small>
            </div>
                           ...
                           $DType=$row['diseaseType'];
                               ...
                               ?>
                                 <tr>
                                    ...
                                    <td>
                                      <img class="table_image" src="../img/products/<?php echo $image;?>"/>
                                    </td>
                                    <td>Rs.
                                     <?php echo $price;?>/=
                                    </td>
                                    ...
                                    <td>
                                        <div class="actions">
                                            <span ><a href="update-Products.php?id=<?php echo $id;?>& image_name=<?php echo $image;?>"><img title="Update" src="../img/icons/icons8-refresh-shield-20.png"/></a></span>
                                           
                                            <span ><a onclick="if (confirm('Are you sure you want to remove this product completely?')){return true;}
                else{event.stopPropagation(); event.preventDefault();};"  href="delete-product.php?id=<?php echo $id;?>& image_name=<?php echo $image;?>"><img title="Remove" src="../img/icons/icons8-remove-20.png"/></a></span>
                                        </div>
                                    </td>
                                </tr>
                             <?php
