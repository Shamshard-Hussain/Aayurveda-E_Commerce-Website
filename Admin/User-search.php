...
include '../connect.php';
  ...
  if ( strlen( $search ) == 0 ) {
    echo '<script>
 alert("Search field is empty!");window.location.href="Admin-View-user-list-Page.php";
 </script>';
  } else {
   ?>
<html lang="en">
                ...
                <div class="records table-responsive">
                    ...
                    <div class="admin_table">
                        <table width="100%" >
                            ...
                            <?php 
                             $sql ="SELECT * FROM customers WHERE Customer_ID LIKE '%$search%' OR First_Name LIKE '%$search%'OR Last_Name LIKE '%$search%' OR Email LIKE '%$search%' OR Phone LIKE '%$search%' OR Dob LIKE '%$search%' OR Gender LIKE '%$search%' OR Home_No LIKE '%$search%' OR Street_name LIKE '%$search%' OR City LIKE '%$search%'";
                                    ...
                                    <td>#<?php echo $Customer_ID;?></td>
                                     <td>
                                        <div class="client">
                                         ...
                                         <div class="client-img bg-img" style="background-image: url(../img/Doctors/profile-user.png)"></div>
...
<?php
 ...
 echo '<script>window.location.href="Admin-View-user-list-Page.php";</script>';}
    ?>
